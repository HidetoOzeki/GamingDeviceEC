...
<div class="wrap_admin_control_item">
    <table>
        ...
        <?php for($i = 0;$i < 5;$i++): ?>
            <tr><td  class="control_item_desc"><input type="text" name="new_product" style="width:180px;"></td><td><form action="toroku.php" ><button>登録</button></form></td><td><form action="delete.php" ><button>削除</button></form></td></tr>
        <?php endfor; ?>
    </table>
</div>
