...
<?php require 'modules/serach_box.php'; ?>
        ...
        if(isset($_GET['product_name'])){
            ...
            $sql = $pdo->prepare('select * from product where (product_name LIKE ? or category_id = (SELECT category_id from category WHERE category_name = ?)) and product_delete_flg = "false"');
            $sql->execute([$search_product,$_GET['product_name']]);
